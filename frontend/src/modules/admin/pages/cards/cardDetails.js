...
const CardDetails=()=>{
    ...
    const getcarddetails = async () => {
        let result = await fetch("http://localhost:5000/carddetails/", {
              method: "POST",
                        ...
                        {cardDetails.map(clist=>(
                         <div className="row mt-3" key={clist._id}>
                            <div className="col-lg-12 mb-3">
                                ...
                                <div className="box">
                                    <label className="fw-bold">Card Number</label> <br></br>
                                    <label>{clist.cardnumber}</label>
                                </div>
                                <div className="box">
                                    <label className="fw-bold">Player Name</label> <br></br>
                                    <label>{clist.playername}</label>
                                </div>
                                <div className="box">
                                    <label className="fw-bold">Attributes/SN</label> <br></br>
                                    <label>{clist.attribute}</label>
                                </div>
                                <div className="box">
                                    <label className="fw-bold">Declared Value</label> <br></br>
                                    <label>{clist.totaldv}</label>
                                </div>
                                <div className="box">
                                    <label className="fw-bold">Order Number</label> <br></br>
                            ...
                            <div className="row mb-3 mt-2">
                                ...
                                <div className="col-lg-4">
                                    <Link className="submitbtn" to="/admin/cards/"> <BiLeftArrow></BiLeftArrow> Back To Cards</Link>
                                </div>
                                <div className="col-lg-4"></div>
                            </div>
                         </div>
