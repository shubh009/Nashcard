...
const index = ()=>{
  ...
  const getdata = async () => {
    const res = await fetch(`http://localhost:5000/order-search`, {
      method: "POST",
      headers: {
               ...
               <div className="col-lg-4">
                <div className="Dashboardsec box-shadow upchargesform">
                   ...
                   <div className="form-group pt-3">
                    <label>Cert</label>
                    <input name="cert" onChange={setdata} type="text" className="form-control"></input>
                   </div>
                   <div className="form-group">
                    <label>Order#</label>
                    <input name="orderid" onChange={setdata} type="text" className="form-control"></input>
                   </div>
                   <div className="form-group">
                    <label>Sub#</label>
                    <input name="PSASubs" onChange={setdata} type="text" className="form-control"></input>
                   </div>
                   <div className="form-group pt-3">
                     <Link className="submitbtn" onClick={handleSubmit}>Search</Link>
                   </div>
                   ...
                   <Table striped bordered hover>
                      <thead>
                          ...
                          return <tr key={el._id}>
                             ...
                             <td><Link to="#" className="btn btn-primary">Mark Update Occured</Link></td>
                           </tr>
                          }) : null}
                      </thead>
                   </Table>
