...
const index =()=>{
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (row) =>
    <td>
    <Link to="#" onClick={()=>orderDetails(row.row.userid)} className="">Details</Link>
    </td>
    },
    {
      field: "delete",
...
const reviewDelete = async (id)=>{
  ...
  const getdata = async () => {
    const res = await fetch(`http://localhost:5000/get-review`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      }, body: JSON.stringify({
                 ...
                 <div className="Dashboardsec box-shadow helpform">
                   <div className="row ">
                    <div className="col-lg-8">
                        <div className="Topl">
                            <span className="heading-level-2 mb-3">Review Order Data Table</span>
                        </div>
                    </div> 
                    ...
                    <div className="col-lg-4">
                       ...
                       <select value={datas} className="form-control"  onChange={handlestatus}>
