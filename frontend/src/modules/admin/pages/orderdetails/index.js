...
const index=()=>{
  ...
  //manage toast
    const notify = () => toast.success("WOW! PSA SUB & order status has been updated");
  ...
  //state to manage the edit order modal popup
    ...
    const handleEditShow = () => {
      ...
      const getOrderDetailsForEdit=async()=>{
        let result=await fetch('http://localhost:5000/orders-details-perid',{
          method: "post",
  ...
  const bindServiceLevelDDL= async()=>{   
    let response = await fetch('http://localhost:5000/getservicelevel/'+grname, {
        method: 'get',
        headers: {
                  'content-type': 'application/json'
                },
  ...
  const getdataGrades = async () => {
    const res = await fetch("http://localhost:5000/get-grades", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  const orderDetails = async ()=>{
      let result = await fetch("http://localhost:5000/getOrderAndCardDetails/"+upid, {
              method: "POST",
  ...
  const uploadGrads=async(e)=>{
    ...
    if (file !== null) {			
      ...
      Axios.post("http://localhost:5000/uploadGrades", formValue, {
          headers: {
...
const updatePSANo=async()=>{
  let result = await fetch('http://localhost:5000/updatePSASUB/', {
      method: "PATCH",
      body: JSON.stringify({ 
          _id:odid, 
          PSASub:psasubno, 
...
const markorderpaid=async()=>{
  alert(odid);
  let result = await fetch('http://localhost:5000/markorderpaid/', {
      method: "PATCH",
      body: JSON.stringify({ 
          orderid:odid,  
          isorderpaid:true
...
const getnotesList=async()=>{
  ...
  let result = await fetch('http://localhost:5000/ordernotelist/'+upid, {
    method: "post",
    body: JSON.stringify({ orderid:odid }),
    headers: {
        'content-type': 'application/json'
...
const getUserAndOrderDetails=async()=>{
  let result=await fetch('http://localhost:5000/getOrderAndCustomerDetails/',{
    method: "post",
    body: JSON.stringify({ orderid:odid }),
    headers: {
        'content-type': 'application/json'
...
const handleDelete = async(note) =>{
  let result = await fetch('http://localhost:5000/deletenote',{
    method:"DELETE",
    body: JSON.stringify({
      userid:upid,
      orderid:orderid,
...
const updateOrderdetails= async()=>{
  handleEditClose()
  let result = await fetch('http://localhost:5000/updateOrderFromAdmin/'+odid, {
    method: "PATCH",
    body: JSON.stringify({ 
        userid:upid,
...
const updateOrderStatus=async(e)=>{
  ...
  let result = await fetch('http://localhost:5000/updateOrderStatus/', {
      method: "PATCH",
      body: JSON.stringify({ 
...
const sendOrderStatusOnEmail=async(e)=>{
  //alert(e.id);
  let result = await fetch('http://localhost:5000/sendOrderStatusOnEmail/', {
      method: "POST",
      body: JSON.stringify({ 
...
const getGradelistbyUserid=async()=>{
  ...
  let result = await fetch('http://localhost:5000/gradelistbyuserid/', {
      method: "POST",
      body: JSON.stringify({ 
...
const deleteGrade=async(e)=>{
  ...
  let result = await fetch('http://localhost:5000/deleteGrade/', {
    method: "DELETE",
    body: JSON.stringify({ 
...
const getImg = async(cert)=>{
  ...
  const response = await axios.get(`https://api.psacard.com/publicapi/cert/GetImagesByCertNumber/${cert}`, { headers });
    ...
    return(
        <>
           ...
           <Modal show={psaCopypopup} onHide={handlepsasubpopuphide} size="lg">
              ...
              <Modal.Footer>
                 <Button variant="secondary" onClick={handlepsasubpopuphide}>Close</Button>
              </Modal.Footer>
            </Modal>

            <Modal show={nonpsaCopypopup} onHide={handlenonpsasubpopuphide} size="lg">
              <Modal.Header closeButton>
              ...
              <Modal.Body>
              {
                ...
                <div className="col-lg-3">
                   <div className="statebox">
                      ...
                      <p className="mb-1">{user.name}{user.lastname}</p>
                    </div>
                </div>
                <div className="col-lg-3">
                   <div className="statebox">
              ...
              <Modal.Footer>
                 <Button variant="secondary" onClick={handlenonpsasubpopuphide}>Close</Button>
              </Modal.Footer>
            </Modal>
           ...
           <Modal show={show} onHide={handlepsasubpopuphide}>
            ...
            <Modal.Body>
              <textarea className="textareap" onChange={(e)=>setNote(e.target.value)}></textarea>
            </Modal.Body>
            <Modal.Footer>
               <Button variant="secondary" onClick={handleClose}>
                ...
                <button type="submit" className="btn btn-primary" onClick={handleSave}> Add New Note</button>
                               ...
                               <div className="form-group mt-4 mb-4">
                                    <form className="text-center mb-5" >
                                      <ul className="list-inline list-unstyled">
                                        <li className="list-inline-item"> <input style={{display: 'none'}} ref={inputRef} type="file" onChange={handleFileChange} />
                                       <Link className="text-theme mb-1 pt-3 d-block text-decoration-none" onClick={handleClick}><BiPlusCircle></BiPlusCircle> Select A CSV File To Upload</Link></li>
                                       <li className="list-inline-item mx-4"> <label className="mb-2">{carduploadfilename}</label></li>
                                      </ul>
                                      
                                      
                                      <center> <button className="submitbtn  d-block w270 text-center" type="submit" onClick={uploadGrads} >Log Cards Via CSV</button></center>
                                    </form>     
                               ...
                               <tr>
                                ...
                                </tr>
                                {
                                   ...
                                   <tr className={glist._id}>
                                      ...
                                      <td>{<img src={frontImage} alt="front" style={{height:'7rem',width:'4.5rem'}} />}</td>
                                      <td>{<img src={backImage} alt="back" style={{height:'7rem',width:'4.5rem'}} />}</td>
                                      <td className="bg-success text-center text-text-decoration-none"><Link to="#" onClick={(e)=>getImg(glist.cert)} className="text-white">Get Images</Link></td>
                                      <td>{glist.psasub}</td>
                                      <td className="bg-primary text-center text-decoration-none"><Link to="/admin/edit-grades/" onClick={gradeDetails(glist.orderid)} className="text-white">Edit</Link></td>
                                      <td className="bg-danger text-center text-decoration-none"><Link to="#" 
                                      onClick={(e)=>deleteGrade({
                                        _id:glist._id, orderid:glist.orderid
                                        })} 
                                      className="text-white">Delete</Link></td>
                                    </tr>
          ...
          <Modal show={viewCustomerinfoShow} onHide={handleViewinfopopupClose} size="lg">
            <Modal.Header closeButton>
            ...
            <Modal.Body>
              ...
              <div className="row py-4">
                <div className="col-lg-3">
                   <div className="highlightboxbox box-shadow">
                     ...
                     <label className="heading-level-4">Total Numbers of Orders</label>
                    </div>
                </div>
                <div className="col-lg-3">
                   <div className="highlightboxbox box-shadow">
...

             {
              ...
              userOrderDetails.map(glist=>(  
                <> 
              <Table striped bordered hover className="scroll-table-long my-3">
                  <thead>
                    <tr>
           ...
           <Modal show={Editshow} onHide={handleEditClose} size="lg">
            ...
            <Modal.Body>
               <div className="row">
                 ...
                 <input defaultValue={orderDetPerid.name} type="text" className="form-control disabled" disabled></input>
                 </div>
                 </div>
                 <div className="col-lg-6">
                  <div className="form-group">
                  <label>Email</label>
                  <input defaultValue={orderDetPerid.email} type="text" className="form-control disabled" disabled></input>
                  </div>
                 </div>
               </div>
               <div className="row">
                 ...
                 <div className="col-lg-6">
                   <div className="form-group">
                    ...
                    <select defaultValue={orderDetPerid.servicelevel} className="form-control" onChange={onServiceLevelDDL}>
                    <option name="select">Select Service Level</option>
                    {
                         editservicelevel.map(svlist=>(
                         <option value={svlist.servicelevelid} key={svlist.servicelevelid}  
                         >{svlist.servicelevel}</option>
                        ))                      
                    }
                 ...
                 <div className="col-lg-6">
                   <div className="form-group">
                    <label>Status</label>
                    <select defaultValue={orderDetPerid.status} className="form-control" onChange={onStatus}>
                       <option name="select">Select Order Status</option>
                       {
                         editStatus.map(Odstatus=>(
                         <option  key={Odstatus._id}  
                         >{Odstatus.status}</option>
                        ))                      
                    }
                    </select>
                   </div>
               ...
               <div className="row">
                 ...
                 <div className="form-group">
                                    ...
                                    <div>
                                        ...
                                        <li>
                                          <input id="r1" type="radio" name="radio" checked={orderDetPerid.localpickup === 1}   value="1" onChange={handleRbOnchange}></input>
                                         <label htmlFor="r1">Yes, I'll drop off and pickup my cards</label>
                                         </li>
                                        <li>
                                          <input id="r2" type="radio" name="radio" value="2" checked={orderDetPerid.localpickup === 2} onChange={handleRbOnchange}></input>
                    ...
                    <label>PSA Up-charge Occurred (add below)</label>
                       ...
                       <ul className="list-unstyled list-inline">
                          <li className="list-inline-item">
                            <input  checked={orderDetPerid.PSAUpcharge === 1}  id="r1" type="radio" name="radio" value="1" ></input>
                            <label htmlFor="r1"> Yes</label>
                          </li>
                          <li className="list-inline-item">
                            <input checked={orderDetPerid.PSAUpcharge === 0} id="r2" type="radio" name="radio" value="0"></input>
               ...
               <div className="row">
                 ...
                 <div className="col-lg-4">
                  <div className="form-group">
                    ...
                    <input defaultValue={orderDetPerid.orderTotal}  type="text" className="form-control disabled" disabled></input>
                  </div>
                 </div>
               </div>
               <div className="row">
                 <div className="col-lg-6">
                  <div className="form-group">
                    ...
                    <input type="text" className="form-control" defaultValue={orderDetPerid.NonLoggedCardCount}
                 ...
                 <div className="col-lg-6">
                  <div className="form-group">
                    ...
                    <input defaultValue={orderDetPerid.Percardpriceofnonloggedcard}  type="text" className="form-control"
               ...
               <div className="row">
                 ...
                 <div className="col-lg-6">
                  <div className="form-group">
                    ...
                    <input defaultValue={orderDetPerid.Kicksfromreview} type="text" className="form-control disabled" disabled></input>
                  </div>
                 </div>
                 ...
                 <div className="col-lg-6">
                  <div className="form-group">
                    ...
                    <input   type="text" className="form-control"
                     ...
                     value={editnoofreviewpasses}></input>
                  </div>
                 </div>
                 <div className="col-lg-6">
                  <div className="form-group">
        ...
        <div className="row">
           ...
           <div className="col-lg-10 noleftrightpadding">
                 ...
                 <ul className="list-inline">
                  <li className="list-inline-item">
                     <div>
                     {
                      ...
                      <Link to="#" className="btn btn-secondary" onClick={(e)=>Statusnotify("Order already Marked as paid")}><BiCheckDouble></BiCheckDouble> Order Paid: Done</Link>
                       :
                       <div className="admintopmenu"><Link to="#" onClick={markorderpaid}>Mark Order Paid</Link></div>
                  ...
                  <li className="list-inline-item">
                     <div className="admintopmenu">
                        <Link onClick={handleViewinfopopupShow}>View Customer Info</Link>
                      </div>
                  </li>
                  <li className="list-inline-item">
                     <div className="admintopmenu">
                        <Link to="#" onClick={handlepsasubpopupshow}>PSA Copy</Link>
                      </div>
                  </li>
                  ...
                  <li className="list-inline-item">
                     <div className="admintopmenu">
                        <Link to="#" onClick={handlenonpsasubpopupshow}>Non PSA Copy</Link>
                      </div>
                  </li>
                  <li className="list-inline-item">
                     <div className="admintopmenu">
                        <Link to="#" onClick={(e)=>updateOrderStatus({id:1})}>Mark As Logged</Link>
                      </div>
                  </li>
                  {/* <li className="list-inline-item">
                     <div className="admintopmenu">
               ...
               <div className="Dashboardsec box-shadow helpform">
                    ...
                    <div className="Topl">
                         <span className="heading-level-2 mb-3"> Order Details</span>
                     </div>
                    <div className="mt-2 main-card">
                       <div className="row">
                         ...
                         <div className="col-lg-2">
                           <div className="statbox">
                           <label className="heading-level-4">Order Date:</label>
                         ...
                         <div className="col-lg-4">
                           <div className="statbox">
                           <label className="heading-level-4">Customer Email:</label>
                       ...
                       <div className="row mt-3">
                         ...
                         <div className="col-lg-2">
                           <div className="statbox">
                           <label className="heading-level-4">Total Cards</label>
                         ...
                         <div className="col-lg-4">
                           <div className="statbox">
                           <label className="heading-level-4">Order Status</label>
                          ...
                          <div className="col-lg-2">
                           <div className="statbox">
                           <label className="heading-level-4">Total Card Price</label>
                         ...
                         <div className="row mt-3"> 
                           <div className="col-lg-2">
                             <div className="statbox">
                               <label className="heading-level-4">Shipment Fee</label>
                               <p className="mb-0">$ 15</p>
                             </div>
                           </div>
                           <div className="col-lg-3">
                             <div className="statbox">
                               <label className="heading-level-4">No of Non Logged Cards</label>
                               <p className="mb-0"> 0</p>
                             </div>
                           </div>
                           <div className="col-lg-3">
                             <div className="statbox">
                               <label className="heading-level-4"> Price Per Non Logged Card</label>
                               <p className="mb-0"> 0</p>
                             </div>
                           </div>
                           <div className="col-lg-3">
                             <div className="statbox">
                               <label className="heading-level-4"> Non-Logged Cards Price</label>
                               <p className="mb-0"> 0</p>
                             </div>
                           </div>
                         </div>
                         ...
                         <div className="col-lg-3">
                             <div className="statbox">
                               <label className="heading-level-4"> Total Price Card Saver</label>
                               <p className="mb-0">$ 0.00</p>
                             </div>
                           </div>
                           <div className="col-lg-2">
                             <div className="statbox">
                               <label className="heading-level-4">Card Saver Qty</label>
                               <p className="mb-0">0</p>
                             </div>
                           </div>
                           <div className="col-lg-2">
                             <div className="statbox">
                               <label className="heading-level-4">Card Saver Price</label>
                               <p className="mb-0">$ 0</p>
                             </div>
                           </div>
                           <div className="col-lg-2">
                             <div className="statbox">
                               <label className="heading-level-4"> PSA Upcharge</label>
                               <p className="mb-0"> $ 0</p>
                             </div>
                           </div>
                           <div className="col-lg-2">
                         ...
                         <div className="col-lg-2">
                           ...
                           <div className="col-lg-2">
                             <div className="statbox">
                               <label className="heading-level-4">Customer CSV</label>
                               <p className="mb-0">$ 0</p>
                             </div>
                           </div>
                           <div className="col-lg-2">
                             <div className="statbox">
                               <label className="heading-level-4"> Review Price</label>
                               <p className="mb-0"> $ 0</p>
                             </div>
                           </div>
                           ...
                           <div className="col-lg-2">
                             <div className="statbox">
                               <label className="heading-level-4"> Cell Phone</label>
                               <p className="mb-0">  {order.textmessagealert}</p>
                             </div>
                           </div>
                           <div className="col-lg-3">
                             <div className="statbox">
                               <label className="heading-level-4"> Drop Off & Pickup Location</label>
                               <p className="mb-0">  0</p>
                             </div>
                           </div>
                         ...
                         <div className="col-lg-3">
                             <div className="statbox">
                               <label className="heading-level-4"> Insurance Ammount</label>
                               <p className="mb-0">$ {order.insuranceammount}</p>
                             </div>
                           </div>
                           <div className="col-lg-3">
                             <div className="statbox">
                               <label className="heading-level-4">Total Insurance Cost</label>
                               <p className="mb-0">$ {order.caculatedinsurancecost}</p>
                             </div>
                           </div>
                           <div className="col-lg-2">
                             <div className="statbox">
                               <label className="heading-level-4">Order Total</label>
                               <p className="mb-0">$ {order.TotalPrice}</p>
                             </div>
                           </div>
                           <div className="col-lg-3">
                             <div className="statbox">
                               <label className="heading-level-4"> Local Pickup & Dropoff</label>
                               <p className="mb-0"> 
                                 {
                                    order.localpickup===1
                  ...
                  <li className="list-inline-item">
                     <div className="admintopmenu">
                        ...
                        <Link to="#" onClick={handleEditShow}>Edit Order</Link>
                      </div>
                  </li>
                  <li className="list-inline-item">
                     <div className="admintopmenu">
                      
                        <Link to="#" onClick={handleEditGradeShow}>Edit Grades</Link>
                      </div>
                  </li>
                  <li className="list-inline-item">
                     <div className="admintopmenu">
                        <Link to="#" onClick={(e)=>sendOrderStatusOnEmail({id:1})}>Send Status Update</Link>
                      </div>
                  </li>
                  <li className="list-inline-item">
                     <div className="admintopmenu">
                  ...
                  <li className="list-inline-item">
                     <div className="admintopmenu">
                        <Link to="#" onClick={(e)=>sendOrderStatusOnEmail({id:2})}>Send Reminder To Pay</Link>
                      </div>
                  </li>
                  <li className="list-inline-item">
                     <div className="admintopmenu">
                        <Link to="#" onClick={(e)=>sendOrderStatusOnEmail({id:3})}>Send Grade Pop Reminder</Link>
                      </div>
                  </li>
                  <li className="list-inline-item mt-3">
                     <div className="admintopmenu">
                        <Link to="#" onClick={(e)=>sendOrderStatusOnEmail({id:4})}>Email Customer Reciept(walk-ins) </Link>
                      </div>
                  </li>

                  <li className="list-inline-item mt-3">
                     <div className="admintopmenu">
                        <Link to="#" onClick={(e)=>updateOrderStatus({id:2})} >Email Review Result </Link>
                      </div>
                  </li>
                  <li className="list-inline-item mt-3">
                     <div className="admintopmenu">
                          ...
                          <div className="theme-highlight-div mb-4 text-center">
                               <div className="form-group mt-4 mb-4">
                                    <form className="text-center mb-2" >
                                       ...
                                       <Link className="text-theme mb-1 d-block text-decoration-none" onClick={handleClick}><BiPlusCircle></BiPlusCircle> Select A CSV File To Upload</Link>
                                       <label className="mb-2">{carduploadfilename}</label>
                                      <center> <button className="submitbtn d-block w270 text-center" type="submit" onClick={Addnewcard} >Log Cards Via CSV</button></center>
                                    </form>     
                    ...
                    <div className="row">
                      <div className="col-lg-4"></div>
                        <div className="col-lg-4 d-block text-center">
                               ...
                               {
                                updatebtn?
                                <button className="submitbtn d-block mt-4 mt-2" type="submit" onClick={updatecarddetails}>Update Logged Card Details</button>
                                 :
                                 <button className="submitbtn d-block mt-4 mt-2" type="submit" onClick={Addnewcard} >Log Card</button>
                               }
                     ...
                     <div className="row orer-details">
                         <div className="Topl mb-3">
                            <div className="row">
                              ...
                              <div className="col-lg-3">
                                <DownloadTableExcel filename="Cards Records" sheet="Cards Data"
                                  currentTableRef={tableRef.current}>
                                  <button className="submitbtn w270"> 
                                  <TbTableExport></TbTableExport> Export To excel </button>
                                </DownloadTableExcel>
                              </div>
                            </div>
                                     ...
                                     isEmpty?
                                      ...
                                      : 
                                      <Table striped bordered hover className="mt-3" ref={tableRef}>
                                                 <thead>
                                                 <tr>
                                                   <th>Qty</th>
                                                   <th>Card year</th>
                           ...
                           <div className="Topl mb-3">
                            ...
                            <div>
                              <div className="form-group">
                                ...
                                <input type="text"  onChange={(e)=>setpsasubno(e.target.value)}
                                       value={psasubno} className="form-control"></input>
                              </div>
                                <div className="form-group">
                                <label className="fw-bold">Order Status</label>
                                  <select name="ServiceLevel" id="ServiceLevel" className="form-control" disabled>                                  
                                   <option value="1" key="ddl name" name="select">Awating Card List</option>
                                </select>
                                </div>
                                  <p className="mt-3">Add number on individual basis </p>
                                  <p>This sets status to: <span className="bg-danger px-3 py-1 text-white rounded-3 mt-2">Cards Logged</span> </p>
                                  <p>
                                    <b>NOTE:</b> This does NOT send an email OR update Card status. This is done on the Order Logging Screen when you click Mark as Logged.  
                                    <span className="fw-bold">
                                       HOWEVER, IF status above is Cards Rec'd, Cards Sent to PSA or Grades Popped, this WILL update PSA # in the Card list as shown above. 
                                    </span>
                                  </p>
                                  <p>
                                    <b> Protip:</b> Add a temporary number here like 999. Then go back to the main orders screen and do a bulk update and set condition of when PSA Sub # is 999 set PSA Sub # to actual submission number given. 
                                  </p>



                                <button className="submitbtn d-block mt-4 mt-2" type="submit" 
                                onClick={updatePSANo}>Add PSA SUB</button>
                      ...
                      <div className="col-lg-6">
                        <div className="Dashboardsec box-shadow">
                           <div className="row">
                              ...
                              <div className="col-lg-6">
                                <Link className="topbtn" onClick={handleShow}>Add New Note</Link>
                              </div>
                           </div>
                          ...
                          <div className="statebox mb-3 mt-3" key={notes._id}>
                             <div className="row">
                                <div className="col-lg-8">
                                  <div className="form-group">
                                     <label className="heading-level-4">Notes Date</label>
                                     <label>{notes.notedate}</label>
                                  </div>
                                </div>
                                <div className="col-lg-4">
                                  <div className="form-group">
                                     <label className="heading-level-4">User Name</label>
                             ...
                             <div className="row">
                                <button className="btn-danger" onClick={()=>handleDelete(notes)}>Delete Note</button>
                             </div>
                             
                          </div>
                           ))
                            :
                               <label className="text-danger">No Order Notes Found for this details</label>
                            }
                          </>                 
                          </div>
                        </div>
