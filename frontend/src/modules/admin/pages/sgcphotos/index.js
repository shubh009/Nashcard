...
useEffect(()=>{
    const getdata1 = async () => {
      const res = await fetch("http://localhost:5000/get-sgc-photos", {
        method: "POST",
        headers: {
                    ...
                    <div className="col-lg-10">
                        <div className="Topl">
                            <span className="heading-level-2 mb-3">
                                <Link to="https://gosgc.app.box.com/s/9270yvv3r4rwply0j6fbi32t9qauxdry/">Link for SGC Photos Folder</Link>
                                
                            </span>
                            <p>(see directions on Grades table for adding)</p>
                            <p>(see video for using this tool)</p>
                            <p><b>WARNING: </b> Always verify it is the number you expect it to update (in the video I show 4 results, I update 4)</p>
                        </div>
                    </div>     
                   </div>
                   <div className="row">
