...
const Address=()=>{
  ...
  const handleSubmit = async (e) => {
    ...
    const getdata = async () => {
      const res = await fetch("http://localhost:5000/search-customers-address", {
        method: "POST",
        headers: {
                 ...
                 <div className="row">
                  <div className="col-lg-12">
                    <div className="Dashboardsec box-shadow helpform">
                        <div className="Topl">
                          <span className="heading-level-2">Customer Address Search</span>
                        </div>
                        <div className="row mt-3">
                          <div className="col-lg-8">
                            <input type="text" name="addressSearch" onChange={setdata} placeholder="Enter Customer Address" className="form-control"></input>
                          </div>
                          <div className="col-lg-4">
                            <button onClick={handleSubmit} className=" submitbtn">Search</button>
                          </div>
                        </div>
