...
const handleRePassword = (e) => {
  ...
  const getdata = async () => {
    const res = await fetch("http://localhost:5000/get-customer-updatedata", {
      method: "POST",
      headers: {
          ...
          const getdata = async () => {
            const res = await fetch(`http://localhost:5000/updateprofile`, {
              ...
              headers: {
                ...
                name,lastname,contact,city,address,pincode,stat,email,userid
              }),
            });
            const data = await res.json();
            if (res.status === 422 || !data) {
                  ...
                  <div className="col-lg-12">
                         ...
                         <div className="row">
                           ...
                           <div className="row ">
                              <div className="col-lg-8">
                              <div className="Topl">
                                 <span className="heading-level-2">Update User Details</span>
                              </div>
                              </div>
                         ...
                         <div className="row mt-3">
                            <div className="col-lg-6">
                                <div className="form-group mt-2">
                                  ...
                                  <input type="text" placeholder="First Name"  value={firstname} onChange={handleName} className="form-control"></input>
                                </div>
                                <div className="form-group mt-2">
                                  <label className="fw-bold">Last Name</label>
                                  <input type="text"  placeholder="Last Name"  value={lastname} onChange={handleLastName} className="form-control"></input>
                                </div>
                                <div className="form-group mt-2">
                                  <label className="fw-bold">Address</label>
                                   <input type="text"  placeholder="Address"  value={address} onChange={handleAddress} className="form-control"></input>
                                </div>
                                <div className="form-group mt-2">
                                  <label className="fw-bold">State</label>
                                   <input type="text"  placeholder="State"  value={stat} onChange={handleState} className="form-control"></input>
                                </div>
                            ...
                            <div className="form-group mt-2">
                                  ...
                                  <input type="text" placeholder="Contact" value={contact} name="contact" onChange={handleContact} className="form-control"></input>
                                  {contactValidationError ? <label className="text-danger">Invalid Phone NO</label> : ""}
                                </div>
                                <div className="form-group mt-2">
                                  <label className="fw-bold">Email Id</label>
                                  <input placeholder="Email" value={email} name="email" onChange={handleEmail} type="text" className="form-control"></input>
                                  {emailValidationError ? <label className="text-danger">Invalid Email</label> : ""}
                                </div>
                                <div className="form-group mt-2">
                                  <label className="fw-bold">City</label>
                         <input type="text"  placeholder="City"  value={city} onChange={handleCity} className="form-control"></input>
                                </div>
                                <div className="form-group mt-2">
                                  <label className="fw-bold">Zipcode</label>
                         <input type="text"  placeholder="Zipcode"  value={pincode} onChange={handlePincode} className="form-control"></input>
                                </div>
                                
                            </div>
                            <div className="col-lg-12 text-center">
                            <div className="form-group">
                                 <button onClick={handleSubmit} className="submitbtn text-center">Update User Details</button>
                              </div>
                            </div>
                            </div>
                           </div>
                           ...
                           <div className="col-lg-4">
                            <div className="Dashboardsec box-shadow helpform">
                              ...
                              <div className="form-group">
                                ...
                                <input placeholder="Password" value={password} onChange={handlePass} type="password"  className="form-control"></input>
                                {passwordValidationError ? <label className="text-danger">Password should be greater then 6 character</label> : ""}
                              </div>
                              <div className="form-group">
                                <label>Re Type Password</label>
                                <input  className="form-control" placeholder="Confirm Password" value={rePassword} onChange={handleRePassword} type="password"></input>
                               ...
                               <div className="form-group">
                                 <button onClick={passwordUpdate} className="submitbtn text-center">Change Password</button>
                              </div>
                            </div>
                           </div>   
                        </div>
