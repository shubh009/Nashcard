...
const Customers=()=>{
  ...
  const columns = [
      ...
      },
    {
      ...
      renderCell: (row) =>
      <td>
      <Link to="/admin/update-details/" onClick={()=>orderDetailsUpd(row.row.userid)} className="">Update Customer</Link>
      </td>
    },
  ];
...
useEffect(()=>{
  const getdata = async () => {
    const res = await fetch("http://localhost:5000/get-data-customers", {
      method: "POST",
      headers: {
                  ...
                  <div className="col-lg-12">
                           ...
                           <div className="row pt-3">
                              ...
                              <div className="Topl">
                                ...
                                <div className="col-lg-4">
                                   <Link to="/admin/address" className="submitbtn mt-1 float-start text-ce">Search By Address</Link>
                         ...
                         <div className="Dashboardsec box-shadow helpform">
                                ...
                                <form>
                                    ...
                                    <div className="form-group">
                                        <button className="submitbtn mt-3" type="button" onClick={userSignup}> Signin To Continue</button>
                                    </div>
                                </form>
