...
const PsaOrders=()=>{
  ...
  const getdata = async () => {
    const res = await fetch(`http://localhost:5000/search-psa-orders`, {
      method: "POST",
      headers: {
    ...
    return(
                  ...
                  <div className="col-lg-12">
                    <div className="Dashboardsec box-shadow helpform">
                         <div className="row">
                             <div className="col-lg-12">
                              <div className="Topl">
                                 <span className="heading-level-2">Orders</span></div>
                             </div>
                         </div>
                         ...
                         <div className="col-lg-6">
                                <div className="form-group">
                                    ...
                                    <input type="textbox" name='psasub' value={orderid} onChange={(e)=>setorderid(e.target.value)} onKeyDown={(e)=>searchOrderId(e.target.value)} className="form-control"></input>
      ...
      <Card.Body style={{cursor: 'pointer' }} onClick={()=>handleSuggestion(el.orderid)}>{el.orderid}</Card.Body>
                                ...
                                <div className="col-lg-4 mt-4">
                                   <Link onClick={handleSubmit} className="submitbtn mt-1 float-start text-ce">Search</Link>
                        ...
                        <Table striped bordered hover className="mt-4">
                           <thead>
                               <tr>
                                 ...
                                 <th className="w210">Set All Cards in Order to PSA Sub#</th>      
                                </tr>
                          ...
                          return <tr key={el._id}>
                             ...
                             <td><Link className="text-danger">Set All Cards in Order to PSA Sub#</Link></td>
                           </tr>
                          }) : null}
                            </thead>
                        </Table>
