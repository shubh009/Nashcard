    ...
    const orderAwaitColumns = [
          ...
          },
        {
          ...
          },
          {
            ...
            renderCell: (row) =>
          <td>
          <Link to="#" onClick={(e)=>handleUpdate(row.row.orderid)} className="">Mark as Picked Up</Link>
          </td>
          },
          {
            field: "remind",
            ...
            renderCell: (row) =>
          <td>
          <Link to="#" onClick={()=>orderDetails(row.row.userid)} className="">Remind Customer</Link>
          </td>
          },
      ];
    const orderPickupColumns = [
        {
            ...
            },
          {
              ...
              renderCell: (row) =>
              <td>
             <Link to="/admin/customer/user-details/" onClick={()=>orderDetails(row.row.userid)} className="">Details/Create New Order</Link>
              </td>
            },
            {
              field: "details",
...
const newlyPaidRows = newlyPaid.map((element, index) => ({
  ...
  const getdataOrderAwait = async () => {
    const res = await fetch("http://localhost:5000/get-order-await", {
      method: "POST",
      headers: {
  ...
  const getdataOrderPickup = async () => {
    const res = await fetch("http://localhost:5000/get-order-pickup", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const getdataOrderReturn = async () => {
    const res = await fetch("http://localhost:5000/get-order-request-return", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const getdataOrderNewlyPaid = async () => {
    const res = await fetch("http://localhost:5000/get-order-newly-paid", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const handleUpdate = async (orderid) => {
          const getUpdate = async () => {
            const res = await fetch(`http://localhost:5000/markaspickedup`, {
              method: "PATCH",
              headers: {
                "Content-Type": "application/json",
              }, body: JSON.stringify({
              ...
              <div className="col-lg-10 noleftrightpadding">
                    ...
                    <div className="col-lg-8">
                        <div className="Topl">
                           ...
                           <p>1. Alert Customer Pacakge is Here does two things</p>
                            <ul>
                                <li>Sends email to customer that their package is ready for pickup</li>
                                <li>Sets status as Awaiting Pickup </li>
                            </ul>

                            <p>2. Mark As Picked Up</p>
                            <ul>
                                <li>Sends email to customer that their package has been picked up</li>
                 ...
                 <div className="Dashboardsec box-shadow helpform">
                   <div className="row ">
                    <div className="col-lg-8">
                        <div className="Topl">
                            <span className="heading-level-2 mb-3">Orders Awaiting Pickup</span>
                        </div>
                    </div>     
                   </div>
                   <div className="row">
                 ...
                 <div className="Dashboardsec box-shadow helpform">
                   <div className="row ">
                    <div className="col-lg-8">
                        <div className="Topl">
                            <span className="heading-level-2 mb-3">Orders Picked Up</span>
                        </div>
                    </div>     
                   </div>
                   <div className="row">
                 ...
                 <div className="Dashboardsec box-shadow helpform">
                   <div className="row ">
                    <div className="col-lg-8">
                        <div className="Topl">
                            <span className="heading-level-2 mb-3">Requested Returns - Awaiting Pickup</span>
                        </div>
                    </div>     
                   </div>
                   <div className="row">
                 ...
                 <div className="Dashboardsec box-shadow helpform">
                   <div className="row ">
                    <div className="col-lg-8">
                        <div className="Topl">
                            <span className="heading-level-2 mb-3">Newly Paid Orders</span>
                        </div>
                    </div>     
                   </div>
                   <div className="row">
